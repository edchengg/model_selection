...
parser.add_argument("--label_f1", default='re_**_test_f1', type=str)
parser.add_argument("--test_label_f1", default='re_dev_**_f1', type=str)
...
if __name__ == '__main__':
    ...
    pivot_dev_rank = []
    pivot_dev_kendall = []
    label_f1_t = args.label_f1
    for target_language in ['ar', 'zh']:
        label_f1 = label_f1_t.replace('**', target_language)
        target2source = {'zh': 'ar',
                         'ar': 'zh'}
        ...
        for i in range(len(splits)):
            ...
            en_f1.append(model_one['re_en_dev_f1'])
            
            sr_f1.append(model_one['re_'+sr+'_dev_f1'])

            target_f1.append(model_one[label_f1])
            target_dev_f1.append(model_one['re_' + target_language + '_dev_f1'])
#        print(sorted(target_f1))
#        print(sorted(en_f1))
        kendall_sr1 = kendall_rank_correlation(target_f1, sr_f1)
        kendall_en = kendall_rank_correlation(target_f1, en_f1)
