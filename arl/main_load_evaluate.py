...
parser.add_argument("--feature_task1", default='arl_**_dev_repr', type=str, help='all, all_mono for all features togheter')
parser.add_argument("--feature_task2", default='arl_**_dev_repr', type=str)
parser.add_argument("--target_task", default='arl', type=str)
...
if __name__ == '__main__':
    ...
    print('Target lang:%s, F1:%.2f' % (args.target_language, round(best_model_f1, 1)))
