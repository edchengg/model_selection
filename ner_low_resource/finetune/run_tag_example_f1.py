...
def evaluate(args, model, tokenizer, labels, pad_token_label_id, mode, prefix="", lang="en", lang2id=None, print_result=True):
  ...
  # save out_label_list and preds_list
  torch.save(out_label_list, os.path.join(args.output_dir, '{}.gold'.format(lang)))
  torch.save(preds_list, os.path.join(args.output_dir, '{}.preds'.format(lang)))
...
def main():
  ...
  ## Required parameters
  parser.add_argument("--data_dir", default='/srv/scratch/ychen3411/project00_model_selection/dataset/panx_processed_maxlen128/', type=str,
  ...
  ## Other parameters
  parser.add_argument("--labels", default="/srv/scratch/ychen3411/project00_model_selection/dataset/panx_processed_maxlen128/labels.txt", type=str,
  ...
  if args.do_predict and args.local_rank in [-1, 0]:
    ...
    output_test_results_file = os.path.join(args.output_dir, "48_test_results.txt")
  ...
  if args.do_predict_dev and args.local_rank in [-1, 0]:
    ...
    output_test_results_file = os.path.join(args.output_dir, "48_dev_results.txt")
